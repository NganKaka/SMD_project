...
function Hero() {
  return (
    <section className="relative w-full h-[600px] flex flex-col justify-end overflow-hidden">
      ...
      <div className="relative z-10 flex flex-col items-center text-center mb-20 w-full max-w-6xl mx-auto px-6 lg:px-12">
        <h1 className="font-poppins text-[64px] font-semibold leading-[120%] text-center text-gradient-vertical mb-4">
          Đời sống sinh viên
        </h1>
        <p className="font-poppins text-[20px] font-medium text-[#000000] leading-[120%] text-center w-full">
...
const LightButton = ({ children }) => (
  <button className="bg-[#DFD8FA] text-[#60499C] hover:bg-[#D0C6F5] px-6 py-2 rounded-full font-semibold text-sm transition-colors whitespace-nowrap">
    {children}
  </button>
);
  ...
  return (
    <section className="w-full relative">
      ...
      <div className="relative z-10 max-w-6xl mx-auto px-6 lg:px-12 pt-16 pb-12">
        <h2 className="text-white text-[48px] font-semibold font-poppins leading-[120%] mb-10">Tin nổi bật</h2>
  ...
  return (
    <section className="max-w-6xl mx-auto px-6 lg:px-12 py-16">
      <div className="flex justify-between items-center mb-10">
        <h2 className="text-[48px] font-semibold font-poppins leading-[120%] text-gradient-horizontal">Sự kiện</h2>
        <PrimaryButton>Xem thêm</PrimaryButton>
      </div>

      <div className="flex flex-col lg:flex-row gap-6">
        <div className="w-full lg:w-[55%] flex flex-col group">
          <div className="relative rounded-3xl overflow-hidden h-[340px] md:h-[400px] flex items-center bg-[#FDF8FF]">
            <img src="/images/collective-voice.jpg" alt="The Power of The Collective Voice" className="w-full h-full object-cover object-left group-hover:scale-105 transition-transform duration-700" />
          </div>
          <div className="flex flex-row justify-between items-start mt-6 gap-4 w-full">
            <div className="flex-1">
              <h3 className="font-bold text-[20px] mb-1 leading-[1.3]">WORKSHOP BAN NHẠC ICO: THE POWER OF THE COLLECTIVE VOICE</h3>
              <p className="text-gray-500 font-medium text-[14px]">20:00 - 21:00, 25.03.2026</p>
            </div>
        ...
        <div className="w-full lg:w-[45%] flex flex-col justify-between gap-6">
          <div className="flex gap-4 group cursor-pointer">
             <div className="overflow-hidden rounded-2xl border border-gray-100 shadow-sm shrink-0 w-[140px] md:w-[160px] h-[120px] md:h-[130px] flex items-center justify-center bg-white">
                <img src="/images/casting-call.jpg" alt="Casting Call MV UEH50" className="w-full h-full object-cover object-top group-hover:scale-110 transition-transform duration-500" />
             </div>
          ...
          <div className="flex gap-4 group cursor-pointer">
             <div className="overflow-hidden rounded-2xl border border-gray-100 shadow-sm shrink-0 w-[140px] md:w-[160px] h-[120px] md:h-[130px] flex items-center justify-center bg-white">
               <img src="/images/tech-project.jpg" alt="Tech project" className="w-full h-full object-cover object-center group-hover:scale-110 transition-transform duration-500" />
             </div>
             <div className="flex flex-col justify-between py-1 flex-grow">
               <div>
          ...
          <div className="flex gap-4 group cursor-pointer">
             <div className="overflow-hidden rounded-2xl border border-gray-100 shadow-sm shrink-0 w-[140px] md:w-[160px] h-[120px] md:h-[130px] flex items-center justify-center bg-white">
               <img src="/images/hackathon.jpg" alt="Hackathon" className="w-full h-full object-cover object-center group-hover:scale-110 transition-transform duration-500" />
             </div>
             <div className="flex flex-col justify-between py-1 flex-grow">
               <div>
...
function ExchangeSection() {
  ...
  return (
    <section className="relative w-full max-w-6xl mx-auto px-6 lg:px-12 py-20 mt-20 flex flex-col pt-[100px] min-h-[600px]">
       
       <div className="relative z-10 w-full flex flex-col items-start pr-0 mt-[60px]">
        <h2 className="text-[48px] font-semibold font-poppins text-gradient-horizontal leading-[120%] mb-6 tracking-tight relative z-20">Sinh viên trao đổi</h2>
        <p className="text-[#000000] font-medium text-[20px] leading-[120%] text-justify w-full max-w-2xl relative z-20 mb-8">
        ...
        <div className="relative z-20"><PrimaryButton>Xem thêm</PrimaryButton></div>
      </div>

      <div className="absolute inset-x-0 w-full flex justify-center items-center z-0 pointer-events-none" style={{ top: '20px' }}>
         <div className="relative w-full max-w-5xl pointer-events-auto">
            <img src="/images/map.svg" alt="World Map" className="w-full h-auto object-contain opacity-80" />
            {pins.map((pin) => (
               <div 
                  key={pin.id} 
                  className="absolute flex flex-col items-center z-10 hover:z-30 transform -translate-x-1/2 -translate-y-1/2 cursor-pointer" 
                  style={{ top: pin.top, left: pin.left }}
                  onMouseLeave={() => setActivePin(null)}
                >
                   {activePin === pin.id && (
                      <div className="absolute bottom-8 w-[240px] bg-white rounded-xl shadow-xl overflow-hidden z-30 transition-all duration-300 pointer-events-none">
                   ...
                   <button 
                      ...
                      className="w-8 h-8 flex items-center justify-center text-[#9B64D3] hover:text-[#844391] transform hover:scale-125 transition-transform relative z-20 focus:outline-none"
                   >
...
function ProjectsSection() {
  return (
    <section className="max-w-6xl mx-auto px-6 lg:px-12 pt-4 pb-20 flex flex-col items-center">
      <h2 className="text-[48px] font-semibold font-poppins text-gradient-horizontal leading-[120%] mb-6 text-center tracking-tight">Dự án sinh viên</h2>
      <p className="font-poppins text-[20px] font-medium text-[#000000] leading-[120%] text-justify w-full mt-6 mb-16">
  ...
  return (
    <section className="bg-[#FDF6FF] py-24 w-full border-t border-b border-[#EACCF0]/50 mt-10">
      <div className="max-w-6xl mx-auto px-6 lg:px-12 flex flex-col items-center">
        <h2 className="text-[48px] font-semibold font-poppins text-gradient-horizontal leading-[120%] mb-6 text-center tracking-tight">SMD Moments</h2>
        <p className="text-[#000000] font-medium text-[20px] leading-[120%] mb-16 text-justify max-w-4xl">
          Khám phá những dự án sáng tạo do sinh viên SMD thực hiện, nơi ý tưởng được biến thành sản phẩm thực tế. Từ thiết kế, truyền thông đến nội dung số, mỗi dự án đều phản ánh góc nhìn riêng và hành trình phát triển của các nhà sáng tạo trẻ.
        </p>
